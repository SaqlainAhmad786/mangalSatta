...
<nav class="navbar navbar-expand-sm navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-auto" style="font-size: 14px; gap: 10px; text-transform: uppercase; font-weight: 500;">
            <li class="nav-item">
                <a class="nav-link" style="color: #D39D55" href="/">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: #D39D55" href="/online-play.php">Play Online</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: #D39D55" href="/record-chart.php">Record Chart</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" style="color: #D39D55" href="posting.php">Posting</a>
            </li>
            <li class="nav-item">   
                <?php if(empty($gan)): ?>
                    <a class="nav-link" style="color: #D39D55" href="/admin/index2.php">Admin</a>
                <?php else: ?>
            ...
            <li class="nav-item">
                <?php if(empty($um)): ?>
                    <a class="nav-link" style="color: #D39D55" href="/login.php">User</a>
                <?php else: ?>
        ...
        <div class="d-inline my-2 my-lg-0">
            <?php if(empty($um)): ?>
                <a class="btn btn-outline-danger my-2 my-sm-0" style="border-radius: 6px;" href="/login.php" role="button">Login</a>
                <a class="btn btn-outline-danger ml-2 my-2 my-sm-0" style="border-radius: 6px;" href="/registration.php" role="button">Register</a>
            <?php endif; ?>
        </div>
    </div>
</nav>  
